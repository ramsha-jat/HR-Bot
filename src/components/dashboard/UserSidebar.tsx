import { FaRegChartBar, FaUpload, FaComments, FaSignOutAlt, FaUserTie } from "react-icons/fa";
    ...
    <aside className="w-72 bg-gradient-to-br from-blue-700/80 via-indigo-700/80 to-blue-500/80 text-white flex flex-col justify-between min-h-screen p-8 shadow-2xl border-r border-blue-200/30 backdrop-blur-xl font-sans">
      <div>
        ...
        <nav className="space-y-6">
          ...
          <button className="flex items-center gap-3 w-full py-2 px-3 rounded-lg hover:bg-white/10 hover:text-blue-200 transition-all focus:outline-none focus:ring-2 focus:ring-blue-300" onClick={() => navigate("/user/dashboard")}> <FaRegChartBar /> Dashboard </button>
          <button className="flex items-center gap-3 w-full py-2 px-3 rounded-lg hover:bg-white/10 hover:text-blue-200 transition-all focus:outline-none focus:ring-2 focus:ring-blue-300" onClick={() => navigate("/upload")}> <FaUpload /> Upload Documents </button>
